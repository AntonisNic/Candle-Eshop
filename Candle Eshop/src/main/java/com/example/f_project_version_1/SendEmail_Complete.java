...
public class SendEmail_Complete {
    ...
    public static boolean createandSendMail(String emailg,String subjectg,String messageg) throws AddressException, MessagingException {
        ...
        message.addRecipient(Message.RecipientType.TO, new InternetAddress(emailg));
        message.addRecipient(Message.RecipientType.CC, new InternetAddress("ece318web@gmail.com"));
